  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Total Officers', value: total,   icon: Users,     color: 'text-sky-400',    bg: 'rgba(14,165,233,0.10)' },
                ...
                {(data?.by_department ?? []).map(d => {
                  ...
                  return (
                    <div key={d.department}>
                      ...
                      <div className="h-2 rounded-full overflow-hidden" style={{ background: 'rgba(14,165,233,0.06)' }}>
                ...
                {(data?.by_rank ?? []).map(r => {
                  ...
                  return (
                    <div key={r.rank} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(14,165,233,0.06)' }}>
            ...
            {(data?.by_department ?? []).length === 0 ? (
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { label: 'Total',    value: total, color: '#0ea5e9', bg: 'rgba(14,165,233,0.10)' },
                ].map(s => (
            ...
            {(data?.recent_promotions ?? []).length === 0 ? (
              ...
              <div className="space-y-2.5">
                {(data?.recent_promotions ?? []).map((p, i) => (
                  <div key={i} className="flex items-center justify-between gap-2 py-2" style={{ borderBottom: i < (data?.recent_promotions.length ?? 0) - 1 ? '1px solid rgba(14,165,233,0.06)' : 'none' }}>
                    <div>
