    ...
    <div className="space-y-5 animate-fade-in">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="w-full max-w-md rounded-2xl overflow-hidden shadow-2xl" style={{ background: 'rgba(8,12,24,0.99)', border: '1px solid rgba(99,102,241,0.20)' }}>
                ...
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 flex-wrap mb-2">
                      ...
                      {isLeader && r.callsign && <span className="font-mono text-sky-400 text-xs">{r.callsign}</span>}
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-sm text-slate-400 flex-wrap">
                      ...
                      <span className="text-sky-400 font-semibold">{days} day{days !== 1 ? 's' : ''}</span>
                    </div>
