  ...
  return (
    <div className="space-y-5 max-w-2xl animate-fade-in">
      ...
      <div className="glass rounded-2xl p-5">
        ...
        <div className="flex items-center gap-4 mb-5 p-4 rounded-xl" style={{ background: 'rgba(168,85,247,0.04)', border: '1px solid rgba(168,85,247,0.08)' }}>
      ...
      <div className="glass rounded-2xl p-5">
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={r.l} className="p-3 rounded-xl" style={{ background: 'rgba(15,23,42,0.6)', border: '1px solid rgba(168,85,247,0.06)' }}>
