...
const CERTS: Cert[] = [
  ...
  { name:'Airwing Certification',        category:'Specialist',    desc:'Aviation operations and support.',                            minRank:'Constable', divReq:'GD' },
  { name:'Marine Certification',         category:'Specialist',    desc:'Marine patrol and water operations.',                         minRank:'Constable', divReq:'GD' },
  { name:"Sheriff's Office",             category:'Specialist',    desc:'Court security and civil enforcement.',                       minRank:'Constable', divReq:'GD' },
  { name:'Legal Services',              category:'Investigative', desc:'Legal support and advisory services.',                        minRank:'Constable', divReq:'GD' },
  { name:'Operations Response Unit',     category:'Tactical',      desc:'Highway Tactical Operations.',                                minRank:'Constable', divReq:'Highway' },
  ...
  { name:'OPS 32',                       category:'Tactical',      desc:'Specialised Airwing Operations.',                             minRank:'First Constable', divReq:'CIRT' },
