            ...
            {!checkingExisting && !existing && (
              submitted ? (
                ...
                <div className="glass rounded-2xl p-8 text-center">
                  ...
                  <h2 className="text-xl font-bold text-white mb-2">Sign in with Discord</h2>
                  <p className="text-slate-400 text-sm mb-2 leading-relaxed">
                    Connect your Discord to apply or check your existing application status.
                  </p>
                  <p className="text-slate-600 text-xs mb-6">We only request your username and avatar. No DMs or server access.</p>
                  {error && (
