                ...
                <div className="rounded-2xl overflow-hidden"
                  ...
                  <div className="px-8 pt-10 pb-8 text-center">
                    <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6"
                      style={{ background: 'linear-gradient(135deg,#5865F2,#4752C4)', boxShadow: '0 0 50px rgba(88,101,242,0.5)' }}>
                  ...
                  {/* Feature list */}
                  <div className="mx-6 mb-6 rounded-xl p-4 space-y-2.5" style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid rgba(255,255,255,0.05)' }}>
                    {[
                  ...
                  <div className="px-6 pb-8">
                    <button onClick={handleDiscordAuth}
                      ...
                      style={{ background: 'linear-gradient(135deg,#5865F2,#4752C4)', boxShadow: '0 4px 30px rgba(88,101,242,0.5)', border: '1px solid rgba(88,101,242,0.5)' }}>
